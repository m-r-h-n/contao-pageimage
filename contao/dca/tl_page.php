...
$pm = PaletteManipulator::create()
    ...
    ->addField(['pageVideo','pageImage', 'pageImageOverwriteMeta'], 'image_legend', PaletteManipulator::POSITION_APPEND)
;
...
(
    ...
    'inputType'     => 'fileTree',
    'exclude'       => true,
    'eval'          => array('tl_class'=>'clr', 'fieldType'=>'checkbox', 'orderField'=>'pageVideoOrder', 'multiple'=>true, 'files'=>true, 'filesOnly'=>true, 'extensions'=> 'mp4,ogg', 'isGallery'=>false),
    'sql'           => 'blob NULL',
);
